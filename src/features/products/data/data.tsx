...
export const categories = [
  ...
  },
  {
    value: 'clothing',
    label: '服装',
    icon: () => <div className='size-2 rounded-full bg-pink-500' />,
  },
  {
    value: 'home',
    label: '家居用品',
  ...
  },
  {
    value: 'sports',
    label: '运动用品',
    icon: () => <div className='size-2 rounded-full bg-orange-500' />,
  },
  {
    value: 'beauty',
    label: '美妆',
...
export const locations = [
  ...
  },
  {
    value: 'china',
    label: 'China',
    icon: () => <div className='size-2 rounded-full bg-red-500' />,
  },
  {
    value: 'usa',
    label: 'US',
...
export const suppliers = [
  ...
  {
    value: 'wolf-furniture',
    label: 'Wolf Furniture',
    icon: () => <div className='size-2 rounded-full bg-purple-500' />,
  },
  {
    value: 'wdmf',
  ...
  {
    value: 'tropical-seas-clothing',
    label: 'Tropical Seas Clothing',
    icon: () => <div className='size-2 rounded-full bg-pink-500' />,
  },
]
