...
import { quotesColumns as columns } from './quotes-columns'
...
export function QuotesTable({ data }: DataTableProps) {
  // 本地UI状态
  ...
  const {
    ...
    columnFilters: [
      ...
      { columnId: 'quality', searchKey: 'quality', type: 'array' },
    ],
  })
