                  ...
                  <Card className=''>
                    <CardContent className='flex items-center justify-between py-3'>
                      ...
                      <div className='flex items-center gap-2'>
                        <button className='flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground transition-colors hover:bg-primary/90'>
                          <svg
                            className='h-4 w-4'
                            fill='currentColor'
                            viewBox='0 0 24 24'
                        ...
                        <button className='flex h-8 w-8 items-center justify-center rounded-full border border-input bg-background text-foreground transition-colors hover:bg-accent hover:text-accent-foreground'>
                          <svg
                            className='h-4 w-4'
                            fill='none'
                            stroke='currentColor'
