                    ...
                    <CardContent className='flex items-center justify-between py-3'>
                      <div className='flex items-center gap-3'>
                        <div className='flex flex-col items-center gap-1'>
                          <div className='flex h-12 w-12 items-center justify-center rounded-full bg-blue-300 text-xl font-bold text-blue-700'>
                            W
                          </div>
                          <p className='text-sm font-semibold'>Wendy</p>
                        </div>
                        <div className='flex flex-col gap-0.5'>
                          <p className='text-xs'>8618238616582</p>
                          <p className='text-xs'>wendy@dropsure.com</p>
                        </div>
                      </div>
                      <div className='flex items-center gap-2'>
                        <button className='flex h-8 w-8 items-center justify-center rounded-full bg-green-500 transition-colors hover:bg-green-600'>
                          <svg
                        ...
                        <button className='flex h-8 w-8 items-center justify-center rounded-full bg-orange-500 transition-colors hover:bg-orange-600'>
                          <svg
                            className='h-4 w-4 text-white'
                            fill='none'
                            stroke='currentColor'
                        ...
                        {notifications.map((notification, index) => (
                          ...
                          >
                            ...
                            <div className='flex items-center gap-4'>
                              <div className='text-sm text-blue-300 hover:text-blue-200'>
                                Read More
                              </div>
